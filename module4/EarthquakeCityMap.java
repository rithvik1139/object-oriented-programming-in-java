...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
		    map = new UnfoldingMap(this, 200, 50, 1000, 1000, new MBTilesMapProvider(mbTilesString));
		    earthquakesURL = "2.5_week.atom";  // The same feed, but saved August 7, 2015
		}
		else {
			map = new UnfoldingMap(this, 200, 50, 900, 900, new Google.GoogleMapProvider());
	...
	private void printQuakes() 
	{
		...
		for (Marker c : countryMarkers) {
			...
			System.out.println("Land Quakes " + "; "+ countLand + " and Ocean Quakes " + "; " + countOcean);
		}
